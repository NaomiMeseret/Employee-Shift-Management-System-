...
import com.example.shiftmaster.viewmodel.EmployeeShiftViewModel
...
fun EmployeeShiftScreen(
    ...
    viewModel: EmployeeShiftViewModel = viewModel()
) {
    val shifts by viewModel.assignedShifts
...
private fun EmployeeShiftScreenPreview() {
    EmployeeShiftScreen(onNavItemClick = {})
}